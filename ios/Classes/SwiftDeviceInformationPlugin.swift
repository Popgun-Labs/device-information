...
public class SwiftDeviceInformationPlugin: NSObject, FlutterPlugin {
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    case "getMemoryDetails":
        // NOTE:
        // android counterpart returns free and total memory, ios only returns total
    
        //1. free memory
        // results are way off and there seems like there is no supported method
        // for pulling active ram info in iOS
        // https://stackoverflow.com/questions/5012886/determining-the-available-amount-of-ram-on-an-ios-device/47354072
